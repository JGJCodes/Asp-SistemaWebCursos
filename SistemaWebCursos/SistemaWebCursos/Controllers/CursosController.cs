...
namespace SistemaWebCursos.Controllers
{
    public class CursosController : Controller
    {
        ...
        public CursosController(SistemaWebCursosContext context)
        {
            _context = context;
        }
        ...
        {
            var sistemaWebCursosContext = _context.Curso.Include(c => c.Categoria);
            return View(await sistemaWebCursosContext.ToListAsync());
        }
