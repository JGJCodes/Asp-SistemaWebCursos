...
namespace SistemaWebCursos.Models
{
    ...
    public class Curso
    {
        ...
        * **/
        ...
        //Atributos que define los creditos del curso
        public byte Creditos { get; set; }

        //Atributos que define las horas de enseñanza del curso
        public byte Horas { get; set; }

        //Atributos que define el precio del curso
        public decimal Costo { get; set; }

        //True = Activo, False = Inactivo
        public Boolean Estado { get; set; }

        //Atributos que define la llave foranea
